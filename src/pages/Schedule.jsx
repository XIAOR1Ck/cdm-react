    ...
    return (
        <>
            <form className="max-w-sm mx-auto" onChange={handleChange}>
                ...
                <select name="season" id="season" className="block w-full px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body bg-indigo-950 text-mauve-300">
                    ...
                    <option value="CDOML2024S2">CDM S8</option>
                </select>
            </form>
